...
export default function App() {
  const [authState, setAuthState] = useState<'landing' | 'login' | 'dashboard'>('landing');

  if (authState === 'dashboard') {
    return <DashboardView onLogout={() => setAuthState('landing')} />;
  }

  return <LandingView view={authState as 'landing' | 'login'} setView={setAuthState} onLogin={() => setAuthState('dashboard')} />;
}
